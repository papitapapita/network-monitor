...
import {
  MarkQuotationExpiredRequestDTO,
  QuotationResponseDTO
} from '../dtos';

export class MarkQuotationExpiredUseCase extends UseCase<
  MarkQuotationExpiredRequestDTO,
  QuotationResponseDTO
> {
  constructor(
    ...
    super(logger, 'MarkQuotationExpiredUseCase');
  }

  protected async beforeExecute(
    request: MarkQuotationExpiredRequestDTO
  ...
  protected async executeImpl(
    ...
    const expireResult = quotation.markExpired();
    if (expireResult.isFailure) {
      return this.fail(expireResult.error!);
    }
