import { WirelessSnapshot } from 'domain/wireless-monitoring';
import { WirelessAlertRecord } from 'domain/wireless-monitoring';
import { WirelessStatusResponseDTO, WirelessMetricsDTO } from '../dtos/WirelessStatusResponseDTO';
...
export class WirelessSnapshotMapper {
  public static toStatusDTO(
    ...
    const activeAlerts: WirelessAlertResponseDTO[] = alerts.map(a => ({
      id: a.id.toString(),
