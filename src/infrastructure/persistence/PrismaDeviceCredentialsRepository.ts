...
import {
  ...
  DeviceCredentials
} from 'application/device-inventory/interfaces/IDeviceCredentialsRepository';
import { CredentialsEncryption } from '../wireless-monitoring/crypto/CredentialsEncryption';
