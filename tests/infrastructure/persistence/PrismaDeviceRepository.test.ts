...
const MockedDeviceMapper = DeviceMapper as jest.Mocked<
  typeof DeviceMapper
>;
  ...
  describe('save()', () => {
    ...
    describe('success', () => {
      ...
      it('should include all mutable fields in the update clause', async () => {
        ...
        const call = prisma.device.upsert.mock.calls[0][0] as Record<
          string,
          Record<string, unknown>
        >;
  ...
  describe('findById()', () => {
    ...
    describe('record found — mapping succeeds', () => {
      ...
      it('should call DeviceMapper.toDomain with the raw row', async () => {
        ...
        expect(MockedDeviceMapper.toDomain).toHaveBeenCalledWith(
          rawRow
        );
      });
  ...
  describe('delete()', () => {
    ...
    describe('generic database error', () => {
      ...
      it('should prefix the error with "Database error deleting device"', async () => {
        ...
        expect(result.error).toContain(
          'Database error deleting device'
        );
      });
  ...
  describe('findAll()', () => {
    ...
    describe('database error', () => {
      it('should return a failed Result when findMany throws', async () => {
        prisma.device.findMany.mockRejectedValue(
