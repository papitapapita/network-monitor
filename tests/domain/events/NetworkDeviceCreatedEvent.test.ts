...
describe('NetworkDeviceCreatedEvent', () => {
  ...
  const createEventProps = (
    overrides?: Partial<NetworkDeviceCreatedEventProps>
  ): NetworkDeviceCreatedEventProps => ({
    aggregateId,
    deviceName,
    ipAddress,
  ...
  describe('constructor', () => {
    it('should create an event with all required properties', () => {
      const event = new NetworkDeviceCreatedEvent(createEventProps());
    ...
    it('should create a copy of props to prevent external mutation', () => {
      ...
      const event = new NetworkDeviceCreatedEvent(props);
  ...
  describe('toString', () => {
    it('should return a formatted string representation', () => {
      ...
      expect(str).toContain('NetworkDeviceCreatedEvent');
    ...
    it('should include event name in string', () => {
      ...
      expect(str).toMatch(/NetworkDeviceCreatedEvent/);
    });
  ...
  describe('value object integration', () => {
    ...
    it('should normalize MAC address format', () => {
      const macWithHyphens = MACAddress.create('aa-bb-cc-dd-ee-ff').value;
      const event = new NetworkDeviceCreatedEvent(
    ...
    it('should normalize lowercase MAC to uppercase', () => {
      const macLowercase = MACAddress.create('aa:bb:cc:dd:ee:ff').value;
      const event = new NetworkDeviceCreatedEvent(
  ...
  describe('real-world scenarios', () => {
    it('should represent adding a new router to the network', () => {
      ...
      expect(event.ipAddress.value).toMatch(/^10\./);
      expect(event.macAddress.value).toBe('00:50:56:AA:BB:01');
    });
    ...
    it('should represent deploying a new switch in datacenter', () => {
      ...
      expect(event.macAddress.value).toBe('AA:BB:CC:DD:EE:10');
    });
